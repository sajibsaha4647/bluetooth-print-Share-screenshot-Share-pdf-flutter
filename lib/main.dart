...
import 'package:printinwithpdf/pdf/pdf_page.dart';
import 'package:printinwithpdf/sharewidget.dart';
...
//       providers: [
//         ChangeNotifierProvider(create: (_) => providersss()),
//       ],
//       child: MaterialApp(
//         debugShowCheckedModeBanner: false,
//         home: SafeArea(
//           child: Scaffold(
//             body: MyHomePage(title: 'sf',),
//           ),
//         ),
//       ),
//     );
...
//             Container(width: 200, height: 200, color: Colors.blueGrey, child: img ?? Container(child: Text("sdf",style: TextStyle(color: Colors.green),),))
//           ],
//         ),
//       ),
//     );
...
//                           list.add(LineText(linefeed: 1));
//
//                           ByteData data = await rootBundle.load("Assets/Group.png");
//                           List<int> imageBytes = data.buffer.asUint8List(data.offsetInBytes, data.lengthInBytes);
//                           String base64Image = base64Encode(imageBytes);
//                           list.add(LineText(type: LineText.TYPE_IMAGE, content: base64Image, align: LineText.ALIGN_CENTER, linefeed: 1,height: 100,width: 100));
//
...
//                           List<int> imageBytes = data.buffer.asUint8List(data.offsetInBytes, data.lengthInBytes);
//                           String base64Image = base64Encode(imageBytes);
//                           list1.add(LineText(type: LineText.TYPE_IMAGE, x:10, y:10, content: base64Image,height: 100,width: 100));
//
